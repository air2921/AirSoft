...
namespace AirSoft.Communication.Implementations.Sms
{
    ...
    public class SmsSender(SmsClientWrapper smsClient) : ISender<SmsDetails>
    {
        ...
        /// If any error occurs while sending the SMS, it logs the error and throws a <see cref="TelecomClientException"/>.
        /// </remarks>
        /// <exception cref="TelecomClientException">Thrown when an error occurs during the SMS sending process.</exception>
        ...
        /// it logs the error and throws a <see cref="TelecomClientException"/>.
        /// </remarks>
        /// <exception cref="TelecomClientException">Thrown when an error occurs during the SMS sending process.</exception>
