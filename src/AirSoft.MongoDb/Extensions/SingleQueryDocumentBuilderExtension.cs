...
{
    /// <summary>
    /// Provides extension methods for applying query configurations from a <see cref="SingleQueryDocumentBuilder{TDocument}"/>
    /// to MongoDB queries without pagination support.
    /// </summary>
    /// <remarks>
    /// This static class contains helper methods to build MongoDB queries
    /// with filtering and sorting options, specifically designed for single document operations.
    /// </remarks>
    internal static class SingleQueryDocumentBuilderExtension
    {
        /// <summary>
        /// Applies all configured query modifications from the <see cref="SingleQueryDocumentBuilder{TDocument}"/>
        ...
        /// <item><description>Sorting configuration (when specified)</description></item>
        /// </list>
        /// </remarks>
        internal static IFindFluent<TDocument, TDocument> ApplyBuilder<TDocument>(this IMongoCollection<TDocument> collection, SingleQueryDocumentBuilder<TDocument> builder) where TDocument : DocumentBase
        {
