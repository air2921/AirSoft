...
namespace AirSoft.EntityFrameworkCore.Abstractions
{
    ...
    public interface IRepository<TEntity> where TEntity : IEntityBase
    {
        ...
        public Task<TEntity?> DeleteAsync(IRemoveSingleBuilder<TEntity> builder, CancellationToken cancellationToken = default);
        ...
        public Task<IEnumerable<TEntity>> DeleteRangeAsync(IRemoveRangeBuilder<TEntity> builder, CancellationToken cancellationToken = default);
