...
namespace AirSoft.EntityFrameworkCore.Abstractions.Builders.State.Create
{
    ...
    public sealed class CreateSingleBuilder<TEntity> :
        BaseEntityStateBuilder<CreateSingleBuilder<TEntity>, TEntity>, ICreateSingleBuilder<TEntity> where TEntity : IEntityBase
    {
        /// <summary>
