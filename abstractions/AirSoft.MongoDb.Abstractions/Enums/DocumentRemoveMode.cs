namespace AirSoft.MongoDb.Abstractions.Enums
{
    /// <summary>
    ...
    /// </summary>
    public enum DocumentRemoveMode
    {
        /// <summary>
        ...
        /// <summary>
        /// Remove actual document (ID = 201).
        /// <para>
        /// This mode is useful when you already have loaded document and want to remove it.
        /// </para>
        /// </summary>
        Document = 201,
